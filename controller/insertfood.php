<?php 
    ...
    //Execute the Query
    $res2 = mysqli_query($conn, "INSERT INTO tbl_food SET title = '$title', image_name = '$image_name', featured = '$featured', active = '$active', id = '$id',description='$des',category_id=$category ,price='$price'");
    if($res2==true)
    {
        //Category Updated
