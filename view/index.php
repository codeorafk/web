    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <form action="<?php echo view; ?>food-search.php" method="POST">
            ...
            <?php 
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo view; ?>category-foods.php?category_id=<?php echo $id; ?>">
    ...
    <section class="food-menu">
        ...
        <p class="text-center">
            <a href="<?php echo view; ?>foods.php">See All Foods</a>
        </p>
    </section>
